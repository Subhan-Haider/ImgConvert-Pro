...
const variants = {
  ...
  secondary: 'bg-black/5 dark:bg-white/10 hover:bg-black/10 dark:hover:bg-white/20 border border-slate-400 dark:border-slate-500 text-slate-900 dark:text-white',
